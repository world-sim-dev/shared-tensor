...
provider = AsyncSharedTensorProvider(execution_mode="client", poll_interval=0.05)
...
@provider.share(name="build_delayed_model", wait=False)
...
@provider.share(name="clone_tensor_async", wait=True)
